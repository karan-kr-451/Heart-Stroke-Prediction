...
from src.StrokeProject.entity.config_entity import DataIngestionConfig
from src.StrokeProject.entity.artifact_entity import DataIngestionArtifact
...
from src.StrokeProject.utils.util import read_yaml_file
